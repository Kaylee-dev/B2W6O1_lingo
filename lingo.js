...
// Ik maak een var turn aan zodat ik bij iedere keer als er een woord word ingevoerd hij +1 kan doen als ronde.
var turn = 0;
...
function checkInput(){
	...
	// Als eerste worden de woorden gesplit in een array.
	...
	for(var i = 0; i < inputArray.length; i++){
		...
		// Hier haalt hij het blok op en zet hij de letters in een blok. Turn is dus welke ronde en de i is welk blokje in die ronde.
...
// Hier heb ik een eventlistener toegvoegd dat wanneer je op enter klikt hij gelijk het woord submit. 13 is de key enter.
